...
import { BossDrowTeleportState } from '../../../components/state-machine/states/character/boss/drow/boss-drow_teleport_state';
import { BossDrowPrepareAttackStateState } from '../../../components/state-machine/states/character/boss/drow/boss-drow-prepare-attack-state';
...
export class Drow extends CharacterGameObject {
  ...
  constructor(config: DrowConfig) {
    ...
    this._stateMachine.addState(new BossDrowPrepareAttackStateState(this));
