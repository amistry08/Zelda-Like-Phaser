...
export const DEGUB_COLLISION_ALPHA = 0.6;
...
export const ENEMY_BOSS_TELPORT_STATE_INITIAL_DELAY = 150;
export const ENEMY_BOSS_TELPORT_STATE_FINISHED_DELAY = 500;
...
export const BOSS_HURT_PUSH_BACK_DELAY = 200;
